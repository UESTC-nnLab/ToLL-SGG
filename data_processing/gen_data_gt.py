...
def Parser(add_help=True):
    parser = argparse.ArgumentParser(description='Process some integers.', formatter_class = argparse.ArgumentDefaultsHelpFormatter,
                                     add_help=add_help)
    parser.add_argument('--scans', type=str,default='/home/honsen/tartan/msg_data/3rscan')
    ...
    parser.add_argument('--pth_out', type=str, default='/home/honsen/tartan/msg_data/3rscan_valid', help='pth to output directory',required=False)
...
if __name__ == '__main__':
    ...
    target_relationships = sorted(util.read_classes('/home/honsen/honsen/CVPR2023-VLSAT/data/3DSSG_subset/relationships.txt'))
