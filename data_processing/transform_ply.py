...
def main():
    ...
    val1_Trans = rescan2ref['ab835faa-54c6-29a1-9b55-1a5217fcba19']

    trans = [[ 8.87756050e-01, -4.60308611e-01,  2.27481686e-03,  0.00000000e+00],
             [ 4.60305125e-01,  8.87758732e-01,  1.90193043e-03,  0.00000000e+00],
             [-2.89496337e-03, -6.41340448e-04,  9.99995649e-01,  0.00000000e+00],
             [ 8.13215613e-01, -5.73251963e-01, -9.18139983e-03,  1.00000000e+00]]

    result = None
    # rescan_file_name = define.FILE_PATH+'/rescans.txt'
    rescan_file_name = "/home/honsen/honsen/CVPR2023-VLSAT/output.txt"
