...
class TextSupervisedContrastiveLoss(nn.Module):
    def __init__(self, temperature=0.07, num_negatives=50, text_embeddings_path=None):
        ...
        self.text_embeddings_path = text_embeddings_path or '/home/hyc/hyc_work/sceneGraph/SGG_DIR/scannet_text_embeddings.pt'

        if os.path.exists(self.text_embeddings_path):
            self.text_embeddings_dict = torch.load(self.text_embeddings_path, map_location="cpu")
